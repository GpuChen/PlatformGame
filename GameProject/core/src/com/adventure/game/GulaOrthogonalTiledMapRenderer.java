...
public class GulaOrthogonalTiledMapRenderer extends OrthogonalTiledMapRenderer {

	public GulaOrthogonalTiledMapRenderer(TiledMap map, float scale) {
		super(fixTilesPixelBleeding(map), scale);
	}
